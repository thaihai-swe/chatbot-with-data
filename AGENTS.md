...
This project is indexed by GitNexus as **chatbot-with-data** (4016 symbols, 6522 relationships, 245 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
