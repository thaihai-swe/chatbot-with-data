...
This project is indexed by GitNexus as **chatbot-with-data** (7054 symbols, 10940 relationships, 278 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
