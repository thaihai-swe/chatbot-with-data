...
This project is indexed by GitNexus as **chatbot-with-data** (4943 symbols, 7809 relationships, 265 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
