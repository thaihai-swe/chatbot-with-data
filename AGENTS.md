...
This project is indexed by GitNexus as **chatbot-with-data** (6516 symbols, 10227 relationships, 274 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
