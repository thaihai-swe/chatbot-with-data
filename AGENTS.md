...
This project is indexed by GitNexus as **chatbot-with-data** (5214 symbols, 8225 relationships, 268 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
