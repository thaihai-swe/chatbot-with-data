...
This project is indexed by GitNexus as **chatbot-with-data** (7068 symbols, 10951 relationships, 277 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
