...
This project is indexed by GitNexus as **chatbot-with-data** (6706 symbols, 10493 relationships, 276 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
