...
This project is indexed by GitNexus as **chatbot-with-data** (2998 symbols, 5115 relationships, 209 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
