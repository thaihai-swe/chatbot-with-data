...
This project is indexed by GitNexus as **chatbot-with-data** (4789 symbols, 7639 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
