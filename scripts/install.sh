...
log "  Dry run:  $DRY_RUN"
log "  Package:  adopter docs in core-zero/; maintainer docs stay in the source repo"
log ""
...
warn_orphans() {
  ...
  local orphans=(
    "core-zero/system-specs"
    "core-zero/INSTALL.md"
    "core-zero/ADOPTION_GUIDE.md"
    "HARNESS_CARD.md"
    "core-zero/GLOSSARY.md"
    "core-zero/GOVERNANCE.md"
    "core-zero/PRODUCT_SENSE.md"
    "core-zero/PROJECT_CONSTRAINTS.md"
    "core-zero/QUALITY_POLICY.md"
    "core-zero/RELIABILITY_POLICY.md"
    "core-zero/TECH_DEBT_REGISTER.md"
    "core-zero/TECH_STACK_REFERENCE.md"
    "core-zero/architecture.md"
    "core-zero/code-design.md"
    "core-zero/guides/install.md"
    "core-zero/guides/adoption-guide.md"
    "memories/domains"
