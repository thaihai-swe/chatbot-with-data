...
This project is indexed by GitNexus as **chatbot-with-data** (5597 symbols, 8662 relationships, 270 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
