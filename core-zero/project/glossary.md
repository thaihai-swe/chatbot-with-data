...
<!-- Shared vocabulary for this project. AI agents use this to maintain consistent terminology across specs, code, and documentation. The /context-memory workflow reinforces these terms across durable context. -->
...
<!-- Example:
| User Account | Account | PascalCase class, camelCase variable | class Account, const userAccount |
| Payment Intent | PaymentIntent | PascalCase, prefixed in DB | payment_intents table |
-->
